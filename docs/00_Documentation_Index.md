...
| Path | Subject | Target |
| --- | --- | --- |
| `docs/03_Functional_Requirements.md` | Detailed use-system behaviours and acceptance rules | Phase 0 |
| `docs/04_Non_Functional_Requirements.md` | Quality, security, accessibility, resilience, and operations requirements | Phase 0 |
| `docs/05_User_Stories.md` | Role-centred user stories | Phase 0 |
