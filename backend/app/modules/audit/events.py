...
class AuditAction(StrEnum):
    ...
    WORKSPACE_MODULES_UPDATED = "WORKSPACE_MODULES_UPDATED"
    ...
    FINANCE_CATEGORY_ARCHIVED = "FINANCE_CATEGORY_ARCHIVED"
    FINANCIAL_EVENT_SUBMITTED = "FINANCIAL_EVENT_SUBMITTED"
    FINANCIAL_EVENT_CREATED_APPROVED = "FINANCIAL_EVENT_CREATED_APPROVED"
    FINANCIAL_EVENT_PENDING_UPDATED = "FINANCIAL_EVENT_PENDING_UPDATED"
    FINANCIAL_EVENT_APPROVED = "FINANCIAL_EVENT_APPROVED"
    FINANCIAL_EVENT_REJECTED = "FINANCIAL_EVENT_REJECTED"
    FINANCIAL_EVENT_REVERSED = "FINANCIAL_EVENT_REVERSED"
    FINANCIAL_EVENT_CORRECTED = "FINANCIAL_EVENT_CORRECTED"
    FINANCIAL_EVENT_ARCHIVED = "FINANCIAL_EVENT_ARCHIVED"
    FINANCIAL_REVIEW_COMMENTED = "FINANCIAL_REVIEW_COMMENTED"
    FINANCIAL_REVIEW_FLAGGED = "FINANCIAL_REVIEW_FLAGGED"
    FINANCIAL_REVIEW_FLAG_RESOLVED = "FINANCIAL_REVIEW_FLAG_RESOLVED"
...
class AuditResourceType(StrEnum):
    ...
    FINANCIAL_EVENT_REVIEW = "FINANCIAL_EVENT_REVIEW"
...
class AuditReason(StrEnum):
    ...
    OWNERSHIP_INVARIANT = "OWNERSHIP_INVARIANT"
