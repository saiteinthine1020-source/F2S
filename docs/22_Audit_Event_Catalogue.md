...
| Safe reason | `INVALID_CREDENTIALS`, `RESOURCE_NOT_FOUND`, `ACCOUNT_INACTIVE`, `MEMBERSHIP_INACTIVE`, `WORKSPACE_INACTIVE`, `PERMISSION_DENIED`, `EXPIRED`, `REPLAY_DETECTED`, `REVOKED`, `VALIDATION_FAILED`, `STALE_VERSION` |
